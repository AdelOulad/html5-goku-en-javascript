...
function Character() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/vegeta.png";
 ...
 this.update = function () {
  if (keyboard.getPressed() == ' ') {
   this.image.src = "Imagenes/vegeta.png";
...
function Minicell() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/cech.jpg";
 ...
 this.update = function () {
  ...
  if (this.flag == false) this.yPos += 2;
  else if (this.flag == true) this.yPos -= 2;
 };
